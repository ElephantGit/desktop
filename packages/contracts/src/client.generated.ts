...
export function createContractsClient(
  ...
  return {
    ...
    fileSystem: {
      copyProjectEntry: (request, options) =>
        executeOperation(
          "copyProjectEntry",
          request,
          transport,
      ...
      copyWorkspaceEntry: (request, options) =>
        executeOperation(
          "copyWorkspaceEntry",
          request,
          transport,
      ...
      createProjectEntry: (request, options) =>
        executeOperation(
          "createProjectEntry",
          request,
          transport,
      ...
      createWorkspaceEntry: (request, options) =>
        executeOperation(
      ...
      deleteProjectEntry: (request, options) =>
        executeOperation(
          "deleteProjectEntry",
          request,
          transport,
      ...
      deleteWorkspaceEntry: (request, options) =>
        executeOperation(
      ...
      moveProjectEntry: (request, options) =>
        executeOperation(
          "moveProjectEntry",
          request,
          transport,
      ...
      moveWorkspaceEntry: (request, options) =>
        executeOperation(
          "moveWorkspaceEntry",
          request,
          transport,
