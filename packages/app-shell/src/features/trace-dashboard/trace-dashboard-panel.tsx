...
export function TraceDashboardPanel({
  ...
  // The plugin-ized dashboard routes in the click handler (useOpenTraceDashboard)
  // before this sheet ever opens; what renders here is the legacy fallback for
  // installs without the plugin.
