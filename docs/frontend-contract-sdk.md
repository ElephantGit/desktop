...
English | [中文](frontend-contract-sdk.zh.md)
...
- `dto/`, containing one `.ts` DTO file per Ora contract family, generated by `ts-rs`; fields that embed ACP payloads reference the official `@agentclientprotocol/sdk` types instead of generating a second ACP schema
- `dto/error.ts`, the generated request-id and discriminated public-error contract
