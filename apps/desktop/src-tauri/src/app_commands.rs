...
desktop_command_registry! {
    ...
    diagnostic_logs::download_plugin_log,
    ...
    commands::plugin::get_plugin_log_level,
    ...
    commands::plugin::list_mcp_health,
    commands::plugin::list_pack_installations,
    ...
    commands::plugin::pack_uninstall_plan,
    ...
    commands::plugin::probe_mcp_health,
    ...
    commands::plugin::set_plugin_log_level,
